...
public class DeductionsCalculator {
    ...
    private static final MathContext mathContext = new MathContext(DECIMALS, RoundingMode.HALF_UP);
    ...
    private void calculateSocialInsurance() {
        ...
        BigDecimal socialInsuranceYearToDate = totalSocialInsurancePaid.add(socialInsuranceForMonth, mathContext);
    ...
    private void calculateCohesionFund() {
        ...
        BigDecimal totalCohesionFundPaid = payslipHistories.stream()
                ...
                .reduce(BigDecimal::add)
                .orElse(BigDecimal.ZERO);
        BigDecimal cohesionFundYearToDate = totalCohesionFundPaid.add(cohesionFundForMonth, mathContext);
    ...
    private void calculateRedundancyFund() {
        ...
        BigDecimal totalRedundancyFundPaid = payslipHistories.stream()
                ...
                .reduce(BigDecimal::add)
                .orElse(BigDecimal.ZERO);
        BigDecimal redundancyFundYearToDate = totalRedundancyFundPaid.add(redundancyFundForMonth, mathContext);
    ...
    private void calculateIndustrialTraining() {
        ...
        BigDecimal industrialTrainingYearToDate = totalIndustrialTrainingPaid.add(industrialTrainingForMonth, mathContext);
...
//        }
        ...
        return employee.getGrossSalary().multiply(property.getContributionsPercentage().divide(BigDecimal.valueOf(100.0), mathContext));
    }
